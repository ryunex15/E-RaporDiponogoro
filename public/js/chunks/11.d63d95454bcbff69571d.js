                        ...
                        _c(
                          ...
                          [
                            _c(
                              "b-card-group",
                              { attrs: { deck: "" } },
                              _vm._l(_vm.tugasList, function (tugas, index) {
                                return _c(
                                  "b-card",
                                  {
                                    key: index,
                                    staticClass: "mb-3",
                                    attrs: { title: tugas.name },
                                  },
                                  [
                                    _c("b-card-text", [
                                      _vm._v(
                                        "\n          Mata Pelajaran: " +
                                          _vm._s(tugas.subject) +
                                          " "
                                      ),
                                      _c("br"),
                                      _vm._v(
                                        "\n          Deadline: " +
                                          _vm._s(tugas.deadline) +
                                          " "
                                      ),
                                      _c("br"),
                                      _vm._v("\n          Status: "),
                                      _c(
                                        ...
                                        {
                                          class: {
                                            "text-success": tugas.completed,
                                            "text-danger": !tugas.completed,
                                          },
                                        },
                                        [
                                          _vm._v(
