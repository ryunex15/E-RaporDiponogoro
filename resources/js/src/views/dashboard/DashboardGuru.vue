                ...
                <div v-else>
                    ...
                    <b-table-simple bordered responsive>
                        ...
                        <b-tbody>
                            ...
                            <template v-else>
                                <b-tr>
                                    <b-td class="text-center" colspan="7"
                                        >Tidak ada data untuk ditampilkan</b-td
                                    >
                                </b-tr>
                            </template>
                        </b-tbody>
            ...
            <form @submit.prevent="submitPembelajaran">
                ...
                >
                    <b-form-input
                        ...
                        v-model="newPembelajaran.nama_mata_pelajaran"
                        required
                    ></b-form-input>
                </b-form-group>
                ...
                >
                    <div class="mb-1">
                        <b-form-datepicker
                            id="batas-penyerahan"
                            v-model="newPembelajaran.deadlineDate"
                            :locale="'id'"
                            :state="!newPembelajaran.deadlineDate ? null : true"
